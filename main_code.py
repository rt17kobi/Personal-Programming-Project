...
def simplex(x0, objfun, alpha=1, beta=0.5, gamma=2, delta=0.5, btol=24.899208, maxiter=10000):
    ...
    for i in range(maxiter):
        ...
        mid = (g + g1 + g2 + b) / 4  # average of all the points excluding the worst point
...
#  print("Objective-Function:", objfun(b), "Best-Point:", b)
  
  ###### Plot ######
  
  xopt=simplex(x0,objfun)
  sopt=voce(xopt[-1],e)
  plt.plot(e,s,'r.', label='Experimental')
  plt.plot(e,sopt,'b-', label='Simulated')
